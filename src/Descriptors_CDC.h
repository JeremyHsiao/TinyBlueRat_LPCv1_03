...
#ifndef __DESCRIPTORS_CDC_H_
#define __DESCRIPTORS_CDC_H_
...
extern USB_Descriptor_Device_t DeviceDescriptor_CDC;
extern USB_Descriptor_Configuration_CDC_t ConfigurationDescriptor_CDC;
extern uint8_t LanguageString_CDC[];
extern uint8_t ManufacturerString_CDC[];
extern uint8_t ProductString_CDC[];
