...
void init_ssp_gpio(void)
{
	...
	/* SSEL0 */  // here ssel0 is to be controlled by SW.
	Chip_IOCON_PinMuxSet(LPC_IOCON, 0, 2, IOCON_MODE_PULLUP);
	Chip_IOCON_PinMuxSet(LPC_IOCON, 3, 0, IOCON_MODE_PULLUP);
	Chip_GPIO_WriteDirBit(LPC_GPIO_PORT, 0, 2, 1);
	Chip_GPIO_WriteDirBit(LPC_GPIO_PORT, 3, 0, 1);
	Chip_GPIO_WritePortBit(LPC_GPIO_PORT, 0, 2, 1);
	Chip_GPIO_WritePortBit(LPC_GPIO_PORT, 3, 0, 1);
	/* SCK0 */
	Chip_IOCON_PinMuxSet(LPC_IOCON, SSP0_SCK_GPIO_PORT_NUM, SSP0_SCK_GPIO_BIT_NUM, (IOCON_FUNC1 | IOCON_MODE_PULLUP));
	/* MISO0 */
	Chip_IOCON_PinMuxSet(LPC_IOCON, SSP0_MISO_GPIO_PORT_NUM, SSP0_MISO_GPIO_BIT_NUM, (IOCON_FUNC1 | IOCON_MODE_PULLUP));
	/* MOSI0 */
	Chip_IOCON_PinMuxSet(LPC_IOCON, SSP0_MOSI_GPIO_PORT_NUM, SSP0_MOSI_GPIO_BIT_NUM, (IOCON_FUNC1 | IOCON_MODE_PULLUP));
}
/**
