...
extern USB_ClassInfo_HID_Device_t comp_Mouse_CDC_Mouse_HID_Interface;

extern void MyBoard_Buttons_Init(void);
extern void MYBoard_Joystick_Init(void);
